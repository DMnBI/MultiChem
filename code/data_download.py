...
if __name__ == '__main__':
    ...
    moleculeNet_bbbp_url = "https://deepchemdata.s3-us-west-1.amazonaws.com/datasets/BBBP.csv"
    moleculeNet_clintox_url ="https://deepchemdata.s3-us-west-1.amazonaws.com/datasets/clintox.csv.gz"
    ...
    #dc.utils.data_utils.download_url(url=moleculeNet_bbbp_url, dest_dir=cf.origin_dir)
    #dc.utils.data_utils.download_url(url=moleculeNet_clintox_url, dest_dir=cf.origin_dir)
